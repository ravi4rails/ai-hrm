    ...
    if employee.employee_grade.present? 
      ...
      if grade_name == 'A'
        if total_assigned_leaves.to_i > 16
          errors.add('Leaves',  "can not be greather than 16 for grade #{grade_name} employee")
        ...
        if total_assigned_leaves.to_i > 12
          errors.add('Leaves', "can not be greather than 12 for grade #{grade_name} employee")
        ...
        if total_assigned_leaves.to_i > 10
          errors.add('Leaves', "can not be greather than 10 for grade #{grade_name} employee")
        ...
        if total_assigned_leaves.to_i > 8
          errors.add('Leaves', "can not be greather than 8 for grade #{grade_name} employee")
